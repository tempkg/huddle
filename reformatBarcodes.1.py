...
def Main():
    ...
    CELL_LINEAGE_BARCODE_FILTERED_DOMINANT = f'{outdir}/cell_lineageBarcodes.filtered.dominant.txt'
    ...
    data = {
        ...
        'Catalog': ['All lineage-barcode', 'Cells with lineage-barcode', 'Cells with filtered lineage-barcode', 'Cells with filtered dominant lineage-barcode', 'Cells have only one filtered lineage-barcode']
    }
