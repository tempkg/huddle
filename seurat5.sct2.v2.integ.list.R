...
# Integration
integ_rna <- RunHarmonyIntegration(obj=combined_rna, norm_method='SCT', reduc='pca', new_reduc='harmony_rna', umap_reduc='rna.umap', max_dim=30, res_clus=0.4, seed=seed)
