...
# wnn
multiome_wnn <- RunWNNPlus(obj=seu, reduc_rna='harmony_rna', reduc_atac='harmony_atac', dim_max_rna=dim_rna, dim_max_atac=dim_atac, weight_name='SCT.weight', res_clus=0.4, seed=seed)


# save integrated data
saveRDS(multiome_wnn, file=paste0(outdir,'/multiome_integrate.harmony.', dim_rna, '_', dim_atac, '.rds'))
