...
# 'pileup_and_phaseX.R' is edited version based on 'pileup_and_phase.R'
# Hua Sun
...
# Newly added
parser = add_option(parser, '--cellsnp', default = 'cellsnp-lite', type = "character", help = "cellsnp-lite tool")
# Original code
