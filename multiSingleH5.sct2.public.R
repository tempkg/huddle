...
seu <- CreateMultiomeObjectFromH5(h5=h5, min_cells=min_cells, atac_fragment=atac_fragment, barcodeMetrics=barcode_metrics, ref=ref, name=name, annotation=annotation)
...
# filter
cutoff <- CalMedianMaxCutoffN(seu, 0.986, 0.85)
print(cutoff)
