...
def Main():
    ...
    data = {
        ...
        'Catalog': ['Total lineage barcode', 'Total cells matched with lineage barcode', 'Total cells matched with filtered lineage barcode', 'Total cells matched with single filtered lineage barcode']
    }
...
def CountUniqueCellsFromFile(file):
    try:
        ...
        result = subprocess.run(
            [f'cut -f2 {file} | sort -u | wc -l'],  # Command as a single string
