...
parser.add_argument('-d', '--dir', type=str, default='', help='dir')
...
def QC_CellrangerSummaryFile(name, f_data, outfile):
    ...
    report = pd.DataFrame(
        ...
        ['Mean Reads per Cell','>5000','','FAIL'],
        ['Median Genes per Cell','>500','','FAIL'],
        ['Number of Reads','-','','-'],
        ['Valid Barcodes','>0.8','','FAIL'],
        ['Valid UMIs','-','','-'],
        ['Sequencing Saturation','-','','-'],
        ['Q30 Bases in Barcode','-','','-'],
        ['Q30 Bases in RNA Read','-','','-'],
        ['Q30 Bases in UMI','-','','-'],
        ['Reads Mapped to Genome','>0.8','','FAIL'],
        ['Reads Mapped Confidently to Genome','>0.5','','FAIL'],
        ['Reads Mapped Confidently to Intergenic Regions','<0.3','','FAIL'],
        ['Reads Mapped Confidently to Intronic Regions','-','','-'],
        ['Reads Mapped Confidently to Exonic Regions','-','','-'],
        ['Reads Mapped Confidently to Transcriptome','>0.5','','FAIL'],
        ['Reads Mapped Antisense to Gene','<0.3','','FAIL'],
        ['Fraction Reads in Cells','>0.6','','FAIL'],
        ['Total Genes Detected','-','','-'],
        ['Median UMI Counts per Cell','100','','FAIL']],
